...
**Prerequisites**: This is an intermediate-level tutorial. It is required to have completed tutorials on [Functions and Values](https://staging.ocaml.org/docs/functions-and-values), [Basic Data Types](https://staging.ocaml.org/docs/basic-data-types), and [Lists](https://staging.ocaml.org/docs/lists) to begin this one.

### [](https://staging.ocaml.org/docs/polymorphic-variants#origin-and-context)Origin and Context
...
2. If any type can be applied, a type parameter is created.
3. If typing inconsistencies are found, an error is raised.
...
### [](https://staging.ocaml.org/docs/polymorphic-variants#a-note-on-simple-variants-and-polymorphism)A Note on Simple Variants and Polymorphism
...
## [](https://staging.ocaml.org/docs/polymorphic-variants#a-first-example)A First Example

### [](https://staging.ocaml.org/docs/polymorphic-variants#creating-polymorphic-variant-types-from-pattern-matching)Creating Polymorphic Variant Types From Pattern Matching
...
Note each of the above translations into simple variants is correct. However, entering them as-is into the environment would lead to constructor shadowing (unless type annotation is used at pattern or expression level, see section on [Shared Constructors](https://staging.ocaml.org/docs/polymorphic-variants#Shared-Constructors)).
...
### [](https://staging.ocaml.org/docs/polymorphic-variants#tag-sharing)Tag Sharing
...
### [](https://staging.ocaml.org/docs/polymorphic-variants#static-type-checking)Static Type-Checking
...
### [](https://staging.ocaml.org/docs/polymorphic-variants#merging-constraints)Merging Constraints
...
## [](https://staging.ocaml.org/docs/polymorphic-variants#exact-closed-and-open-variants)Exact, Closed and Open Variants

Polymorphic variant type expressions can have three forms:

1. **Exact**: ``[ `Broccoli | `Gherkin | `Fruit of string ]``  
    This only designates the type inhabited by the values introduced by these tags.
2. **Closed**: ``[< `Broccoli | `Gherkin | `Fruit of string ]``  
...
3. **Open**: ``[> `Broccoli | `Gherkin | `Fruit of string ]``  
...
### [](https://staging.ocaml.org/docs/polymorphic-variants#both-open-and-closed-polymorphic-variant)Both Open and Closed Polymorphic Variant
...
## [](https://staging.ocaml.org/docs/polymorphic-variants#subtyping-of-polymorphic-variants)Subtyping of Polymorphic Variants
...
2. Using an annotation, the type can be restrained to ``[ `Gherkin ]``, the exact variant type only containing `` `Gherkin ``
3. Using another annotation allows assigning the `` `Gherkin `` value to a type containing more tags.
...
## [](https://staging.ocaml.org/docs/polymorphic-variants#named-polymorphic-variant-types)Named Polymorphic Variant Types

### [](https://staging.ocaml.org/docs/polymorphic-variants#naming)Naming
...
### [](https://staging.ocaml.org/docs/polymorphic-variants#type-extension)Type extension
...
### [](https://staging.ocaml.org/docs/polymorphic-variants#hash-patterns)Hash Patterns
...
## [](https://staging.ocaml.org/docs/polymorphic-variants#advanced-aliased-parametrized-and-recursive-polymorphic-variants)Advanced: Aliased, Parametrized and Recursive Polymorphic Variants

### [](https://staging.ocaml.org/docs/polymorphic-variants#inferred-type-aliases)Inferred Type Aliases
...
### [](https://staging.ocaml.org/docs/polymorphic-variants#parametrized-polymorphic-variants)Parametrized Polymorphic Variants
...
### [](https://staging.ocaml.org/docs/polymorphic-variants#recursive-polymorphic-variants)Recursive Polymorphic Variants
...
## [](https://staging.ocaml.org/docs/polymorphic-variants#advanced-combined-subtyping-of-polymorphic-and-simple-variants)Advanced: Combined Subtyping of Polymorphic and Simple Variants
...
### [](https://staging.ocaml.org/docs/polymorphic-variants#predefined-simple-variants-are-covariant)Predefined Simple Variants are Covariant
...
### [](https://staging.ocaml.org/docs/polymorphic-variants#function-codomains-are-covariant)Function Codomains are Covariant
...
### [](https://staging.ocaml.org/docs/polymorphic-variants#function-domains-are-contravariant)Function Domains are Contravariant
...
### [](https://staging.ocaml.org/docs/polymorphic-variants#covariance-and-contravariance-at-work)Covariance and Contravariance at Work
...
## [](https://staging.ocaml.org/docs/polymorphic-variants#uses-cases)Uses-Cases

### [](https://staging.ocaml.org/docs/polymorphic-variants#variants-without-declaration)Variants Without Declaration
...
### [](https://staging.ocaml.org/docs/polymorphic-variants#shared-constructors)Shared Constructors
...
Without this, previously entered ones are no longer reachable. This can be worked around using modules. This is explained in [Reusing Field Names](https://dev.realworldocaml.org/records.html#scrollNav-3) ) of the _Real World OCaml_ book written by Yaron Minsky and Anil Madhavapeddy.
...
### [](https://staging.ocaml.org/docs/polymorphic-variants#data-type-sharing-between-modules)Data Type Sharing Between Modules
...
## [](https://staging.ocaml.org/docs/polymorphic-variants#drawbacks)Drawbacks

### [](https://staging.ocaml.org/docs/polymorphic-variants#hard-to-read-type-expressions)Hard-to-Read Type Expressions
...
### [](https://staging.ocaml.org/docs/polymorphic-variants#over-constrained-types)Over Constrained Types

In some circumstances, combining sets of constraints will artificially reduce the domain of a function. This happens when the conjunction of constraints must be taken. Functions `f` and `g` used here are those defined in the [first section](https://staging.ocaml.org/docs/polymorphic-variants#a-first-example).
...
### [](https://staging.ocaml.org/docs/polymorphic-variants#weaken-type-checking-and-harder-debugging)Weaken Type-Checking and Harder Debugging
...
### [](https://staging.ocaml.org/docs/polymorphic-variants#over-approximating-type)Over Approximating Type

The following function was presented in the [Inferred Type Aliases](https://staging.ocaml.org/docs/polymorphic-variants#Inferred-Type-Aliases) section.
